...
- 💡 I love turning complex ideas into clean, functional systems  
- 🧰 Skilled in both backend architecture and 3D visualization  
- 🧪 Currently experimenting with interactive data + visual UI using **Three.js**  
...
- 🏥 Hospital 3D visualization and monitoring system with live sensor data  
- 🔐 Access control with custom guards, role logic, and audit logging  
- 📦 Building reusable backend modules with NestJS  

---

## 📚 Learning Goals

- 💎 Mastering scalable backend systems & database optimization  
- 🧠 Diving deeper into 3D rendering with **Three.js** & **React Three Fiber**  
- 🌐 Creating full-stack apps using **Next.js**  
- 📈 Implementing logging, monitoring, and DevOps best practices  
...
<p><img align="center" src="https://github-readme-stats.vercel.app/api/top-langs?username=kamilprogrammer&show_icons=true&locale=en&layout=compact" alt="kamilprogrammer" /></p>
